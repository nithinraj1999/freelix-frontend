...
// import React, { useEffect, useState } from "react";
// import { fetchAllBids, withdrawMyBid } from "../../../api/freelancer/freelancerServices";
// import { RootState } from "../../../state/store";
// import { useSelector } from "react-redux";
// import EditProposalModal from "./EditProposalModal";
// import { useNavigate } from "react-router-dom";
...
//     if (!jobId) return;
//     try {
//       const data = await fetchAllBids({ jobId });
...
//   const withdrawBid = async (bidID: string) => {
//     try {
//       const response = await withdrawMyBid({ bidId: bidID });
//       if (response.success) {
...
//     <>
//       {bids
//         .filter((bid) => bid.freelancerId._id === user?._id && bid.status !== "Withdrawn")
//         .map((bid) => (
//           <div key={bid._id} className="mt-6 p-6 bg-white">
//             {/* Bid Details */}
//             <div className="flex">
