            ...
            <div className="hidden md:flex items-center space-x-4">
              {user ? (
                <>
                  ...
                  <IoIosNotificationsOutline color="white" size={24} className="cursor-pointer" />
                  <RxEnvelopeClosed color="white" size={24} className="cursor-pointer" />
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    {dropdownVisible && (
                      <div className="absolute right-0 mt-2 w-40 bg-neutral-800 rounded shadow-lg z-50">
                        <button
                        className="block w-full text-left px-4 py-2 text-neutral-50 hover:bg-neutral-700" onClick={profile}
                      >
                        Profile
                      </button>
                      <button
                        className="block w-full text-left px-4 py-2 text-neutral-50 hover:bg-neutral-700" onClick={() => switchToBuyingMode(user._id)}
                      >
                        Switch To Buying
                      </button>
