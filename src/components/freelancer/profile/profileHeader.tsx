...
//   // Effect to update currentData when freelancerData changes
//   useEffect(() => {
//     if (freelancerData) {
//       setCurrentData({
//         name: freelancerData.name || "",
//         rating: "☆☆☆☆☆", // You may want to replace this with a dynamic value if available
...
//   const getInputType = (
//     field: keyof typeof currentData
//   ): "text" | "textarea" | "file" | "skills" => {
//     switch (field) {
//       case "name":
//       case "title":
//         return "text";
...
//       {/* Cover Picture */}
//       <div className="h-60 bg-cover bg-blue-200	-600 w-full"></div>
//       <div>
//         <img
